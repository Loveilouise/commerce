  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="max-height:none" >
          <form class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="ccname" id="form-field-1" value="${Session["company"].ccname}">
              </div>
            </div>
           <div class="control-group">
                  <label class="control-label" for="form-field-1">Company Name<br>公司名称(英)</label>
                  <div class="controls">
                    <input type="text" name="cename" id="form-field-1" value="${Session["company"].cename}">
                  </div>
                </div>
            <div class="control-group">
              ...
              <div class="controls">
                  ...
                  <div id="editor" name="cinfo">
                  <#if
						Session["company"].cinfo!=''> ${Session["company"].cinfo} 
				  <#else>输入内容&hellip;</#if>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="ctype" id="form-field-1" value="${Session["company"].ctype}">
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="curl" id="form-field-1" value="${Session["company"].curl}">
              </div>
            </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" id="btnback" data-dismiss="modal">取消</button>
